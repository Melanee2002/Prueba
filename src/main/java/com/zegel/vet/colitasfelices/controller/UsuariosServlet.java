 ...
 */
package com.zegel.vet.colitasfelices.controller;
import com.zegel.vet.colitasfelices.model.Login;
import com.zegel.vet.colitasfelices.dao.UsuariosDao;
...
public class UsuariosServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Login user = new Login(id, nombres, correo, usuario, password);
            UsuariosDao usuariosDao = new UsuariosDao();
            
            if (request.getParameter("btonguardar" ) != null) {
                res = usuariosDao.insertarUsuario(user);
                if (res != 0){
